let examples = [   
    ...
    ["bạ·kỏ·dũ",";~@**:~@26:_**~@","ba·bạ·ko·kỏ·dũ·du"],
    ["a·no","ke-","ke·a·no"],
    ["a·no","ke=-","ke-·a·no"],
    ["a·no","kes-","kes·a·no"],
    ["a·no","kesr-","kesr·a·no"],
    ...
    ["sreind·flaust","uzi.t!--~or","u·zi·treind·flaus·tor"],
    ["sreind·flaust","uzi.$2--e.v!-","u·zi·sè·veind·flaus·tor"],
    ["sreind·flaust","uzi.$2---e.v-","u·zi·srè·veind·flaus·tor"],
    ["sreind·flaust","-o.f--!.ai","so·freind·flaus·ai"],
    ["sreind·flaust","--o.f--!!.ai","sro·feind·flau·ai"],
    ["sreind·flaust","uzi.t--o.f--!.ai","u·zi·tso·freind·flaus·ai"],
    ["sreind·flaust","uzi.t!---o.f--!!.ai","u·zi·tro·feind·flau·ai"]
]
...
const inflexp_pattern 
    ...
    + "("
    + "("
    + "(?<rightwardRepetitionFirst>(_?=?(~(\\$|%|@)?)*(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*(,(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*)*\\+?(~(\\$|%|@)?)*=?))"
    + "(?<rightwardRepetitionRest>(\\:_?=?(~(\\$|%|@)?)*(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*(,(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*)*\\+?(~(\\$|%|@)?)*=?)*)"
    + "(?<!^|\\-);)"
    + "|"
    + "(;"
    + "(?<leftwardRepetitionFirst>(=?(~(\\$|%|@)?)*(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*(,(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*)*\\+?(~(\\$|%|@)?)*_?=?))"
    + "(?<leftwardRepetitionRest>(\\:=?(~(\\$|%|@)?)*(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*(,(\\$\\$|%%|@@)*(([1-3]?[4-6]?[7-9]?)|\\*{1,3})(\\$\\$|%%|@@)*)*\\+?(~(\\$|%|@)?)*_?=?)*)"
    + ")"
    + "|"
    + "(?<baseRepetition>(#\\+?=?|=?#\\+?)*)"
    + ")?"
